      ...
      <View style={styles.container}>
       {/* <Swiper style={styles.wrapper} height={200} horizontal={false} autoplay>
        ...
        <Swiper
          ...
          activeDot={<View style={{backgroundColor: 'green', width: 8, height: 8, borderRadius: 4, marginLeft: 3, marginRight: 3, marginTop: 3, marginBottom: 3}} />}
          paginationStyle={{
         ...
         {/* <View style={styles.slide}>
          ...
          {
            this.props.imgDataArr.map((item, index)=>(
                <View style={styles.slide} key={index}>
                  <Image resizeMode='stretch' style={styles.image} source={{
                    uri: item.icon_url
                  }} />
                </View>
            ))
